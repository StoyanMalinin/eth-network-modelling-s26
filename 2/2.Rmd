...
```{r, eval=FALSE}
ergm_model_2_params <- glasgow_net1 ~ 
  # Model 1
  edges + 
  nodematch("gender") +
...
-   ii - transitivity (*gwesp.OTP.fixed.0.2*) is supported by the data
...
- **H2** - Children with higher delinquency tend to send more friend nominations
